...
var WrapperProductImage = _styledComponents.default.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  min-width: 55px;\n  min-height: 55px;\n  height: 55px;\n  width: 55px;\n  padding: 3px;\n  border-radius: 8px;\n  background-color: ", ";\n  box-sizing: border-box;\n  @media (min-width: 361px) {\n    height: 80px;\n    width: 80px;\n  }\n  @media (min-width: 411px) {\n    height: 100px;\n    width: 100px;\n  }\n  @media (min-width: 1024px) {\n    height: 120px;\n    width: 120px;\n  }\n"])), function (props) {
  ...
  return props === null || props === void 0 ? void 0 : (_props$theme2 = props.theme) === null || _props$theme2 === void 0 ? void 0 : (_props$theme2$colors = _props$theme2.colors) === null || _props$theme2$colors === void 0 ? void 0 : _props$theme2$colors.secundaryBackground;
});
